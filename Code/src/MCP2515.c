...
#define MCP2515_CS_HIGH() GPIO_SetBits(GPIOA, GPIO_Pin_4)
#define MCP2515_CS_LOW() GPIO_ResetBits(GPIOA, GPIO_Pin_4)
//#define MCP2515_CS_HIGH() HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_SET)
//#define MCP2515_CS_LOW() HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_RESET)
